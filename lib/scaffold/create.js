...
var BASE_PACKAGE = {
  description: 'A full BitCore node build with Bitcore',
  repository: 'https://github.com/dalijolijo/bitcore-node-btx',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-btx': 'dalijolijo/bitcore-lib-btx',
    'bitcore-node-btx': 'dalijolijo/bitcore-node-btx'
  }
};
